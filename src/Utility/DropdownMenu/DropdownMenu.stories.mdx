...
<Canvas style={{ width: "100%" }}>
  <Story name="Default" args={{}}>
    {(args) => (
      <DropdownMenu control={"Options"} {...args}>
...
For *DropdownMenu* animations <u> [framer-motion](https://www.npmjs.com/package/framer-motion) </u> is used, which is controller throught `animation` prop. <u>[framer-motion documentation](https://www.framer.com/docs/animation/)</u> 
