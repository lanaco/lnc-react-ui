...
<Meta title="Utility/Popover" component={Popover}  subcomponents={{ PopoverTrigger, PopoverContent }} />

export const TemplateDefault = (args) => {
 return (
    <div>
      <Popover  placement="bottom">
        <PopoverTrigger><Button>Popover Trigger</Button></PopoverTrigger>
...
Example with *top-end* placement
