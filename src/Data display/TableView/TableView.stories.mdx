...
export const CustomToolbar = (props) => {
  return (
    <div className={props?.className}>
      <Button text="Custom Action" btnType="outline" onClick={() => {}} />
      &nbsp;
...
export const CustomPagination = (props) => {
  return (
    <div className={props?.className}>
      <Button text="Previous" btnType="outline" onClick={() => {}} />
      &nbsp;
      <Button text="Next" btnType="outline" onClick={() => {}} />
    </div>
  );
};
...
<SyntaxHighlighter language="jsx" style={nord}>
  {'import { TableView } from "@lanaco/lnc-react-ui";'}
</SyntaxHighlighter>
...
<SyntaxHighlighter language="jsx" style={nord}>
  {'import { ActionsToolbar } from "@lanaco/lnc-react-ui";'}
</SyntaxHighlighter>
  ...
  <Story name="Ordering" args={{}}>
    {() => {
      ...
      const sortAscending = (accessor) =>
        [...data].sort((a, b) => (a[accessor] > b[accessor] ? 1 : -1));
...
<SyntaxHighlighter language="jsx" style={nord}>
  {"() => {\n" +
    ...
    "             <TextInput\n" +
    '               name="Address"\n' +
    "               onChange={(e, value) => (formValuesRef.current.address = value)}\n" +
    "             />\n" +
    "           </FormField>\n" +
    "         </FlexGridItem>\n" +
    "         <FlexGridItem col={6}>\n" +
