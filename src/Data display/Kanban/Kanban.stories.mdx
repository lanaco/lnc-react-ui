  ...
  <Story name="Default" args={{}}>
    {(args) => (
      <Kanban
        ...
        columns={[{ id: "A", header: "Column A"}, {id: "B", header: "Column B"}, {id: "C", header: "Column C"}]}
      ></Kanban>
    )}
  </Story>
</Canvas>
...
```jsx
import { KanbanHeader, KanbanFooter } from "@lnc-react-ui";
```
...
```jsx
import { KanbanCard } from "@lnc-react-ui";
```
